...
import { LayoutGrid, ClipboardCheck, Users, Tags, FileBarChart2 } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 inset-x-0 z-20 bg-[#f1e8cf] border-t-2 border-[#2b2118]/15 shadow-[0_-4px_12px_-6px_rgba(43,33,24,0.25)]">
